...
<script>(function(){var k="nexus-theme";function a(t){var d=window.matchMedia("(prefers-color-scheme: dark)").matches;var r=t==="dark"||(t==="system"&&d)?"dark":"light";document.documentElement.setAttribute("data-bs-theme",r);document.documentElement.setAttribute("data-theme",r);window.__nexusTheme=t;window.__nexusResolved=r;var o=document.documentElement;if(r==="dark"){o.style.setProperty("--body-bg","#0f1119");o.style.setProperty("--bg","#0f1119");o.style.setProperty("--text","#e4e6eb");o.style.setProperty("--text-secondary","#9ca3af");o.style.setProperty("--border","#2a2d3a");o.style.setProperty("--card-bg","#1a1d29");o.style.setProperty("--header-bg","#1a1d29");o.style.setProperty("--header-border","#2a2d3a");o.style.setProperty("--table-header-bg","#1a1d29");o.style.setProperty("--accent-light","#1e2a45");o.style.setProperty("--sidebar-bg","#0f1119");o.style.setProperty("--sidebar-text","#a0a4b8");o.style.setProperty("--sidebar-hover","#1a1d29");o.style.setProperty("--sidebar-active","#4f7cff");o.style.setProperty("--sidebar-active-text","#ffffff");o.style.setProperty("--sidebar-border","rgba(255,255,255,0.06)");o.style.setProperty("--sidebar-logo","#ffffff");o.style.setProperty("--sidebar-version","rgba(255,255,255,0.3)");o.style.setProperty("--sidebar-btn-border","rgba(255,255,255,0.15)")}else{o.style.setProperty("--body-bg","#f5f6fa");o.style.setProperty("--bg","#f5f6fa");o.style.setProperty("--text","#1a1d29");o.style.setProperty("--text-secondary","#6b6f80");o.style.setProperty("--border","#e2e4e8");o.style.setProperty("--card-bg","#ffffff");o.style.setProperty("--header-bg","#ffffff");o.style.setProperty("--header-border","#dee2e6");o.style.setProperty("--table-header-bg","#f5f6fa");o.style.setProperty("--accent-light","#e8edff");o.style.setProperty("--sidebar-bg","#ffffff");o.style.setProperty("--sidebar-text","#1a1d29");o.style.setProperty("--sidebar-hover","#f0f2f5");o.style.setProperty("--sidebar-active","#4f7cff");o.style.setProperty("--sidebar-active-text","#ffffff");o.style.setProperty("--sidebar-border","#e2e4e8");o.style.setProperty("--sidebar-logo","#1a1d29");o.style.setProperty("--sidebar-version","#9aa0b0");o.style.setProperty("--sidebar-btn-border","#d0d2d8")}var i=document.getElementById("theme-icon");if(i){if(t==="dark"){i.innerHTML='<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/>'}else if(t==="light"){i.innerHTML='<circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/>'}else{i.innerHTML='<rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>'}}}var s=localStorage.getItem(k)||"system";a(s);window.__nexusApply=a;window.toggleTheme=function(){var c=localStorage.getItem(k)||"system";var n=c==="system"?"light":c==="light"?"dark":"system";localStorage.setItem(k,n);a(n)};window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",function(){var t=localStorage.getItem(k)||"system";if(t==="system")a("system")})})();</script>
