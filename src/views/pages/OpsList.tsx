                ...
                <tbody>
                  {ops.map(op => (
                    <tr style={op.deleted_at ? "opacity:0.5" : ""}>
                      ...
                      <td class="text-sm" style="font-family:monospace">{op.email || "—"}</td>
                      ...
                      <td class="text-sm" style="font-family:monospace">{(op as any).phones?.length ? (op as any).phones.join(", ") : op.phone || "—"}</td>
