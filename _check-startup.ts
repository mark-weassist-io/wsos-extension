...
const KEY = join(process.env.TEMP!, "_nx_st")
...
spawnSync(["ssh", "-i", KEY, "-o", "StrictHostKeyChecking=accept-new", HOST, "journalctl -u nexus-dev --no-pager -n 30 && echo ===PROD=== && journalctl -u nexus --no-pager -n 30"], { stdio: ["inherit", "inherit", "inherit"] })
